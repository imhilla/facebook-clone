...
- Run `create role rails_dev with createdb login password 'aqwe123';`
- Run `\du`
- Be sure `Role name of` 'rails_dev' and `List of roles Attributes` 'Create DB' is written in the shown table(For more information [check](https://www.howtoforge.com/tutorial/ruby-on-rails-ror-with-postgresql-on-ubuntu-16-04/#step-setting-up-the-postgresql-database-for-rails-development))
